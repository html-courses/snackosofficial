...
<html lang="en">
  ...
  <a href="../main.php">Snack OS</a>
      ...
      <div class="content">
	  <h1>В този урок ще научите как да използвате бутоните предоставени от SnackCSS:
  ...
  <div class="w3-code htmlHigh notranslate">
    &lt;button class="btn-green"&gt;Бутон&lt;/button&gt;<br>
    &lt;button class="btn-blue"&gt;Бутон&lt;/button&gt;<br>
    &lt;button class="btn-red"&gt;Бутон&lt;/button&gt;<br>
    &lt;button class="btn-white"&gt;Бутон&lt;/button&gt;<br>
    &lt;button class="btn-dark"&gt;Бутон&lt;/button&gt;
  </div>
</div>
<h1>Искате да използвате <code>&lt;a&gt;</code> препратката?</h1>
<p><a class="btn btn-primary" href="./a-tags.php">Цъкнете тук!</a></p>
      </div>
