	...
	<nav class="navbar navbar-light bg-light">
	  <div class="container-fluid">
		<a class="navbar-brand" href="#">
		      <img id="preview" src="" alt="" width="49px" height="59px;" style="border-radius: 50%;"><button type="button" class="btn btn-link" id="launch" data-bs-toggle="modal" data-bs-target="#exampleModal">
  Навигационна лента
</button></a>
	  </div>
	</nav>
