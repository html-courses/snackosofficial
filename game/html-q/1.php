...
<center><h1>Какво означава съкращението HTML:</h1></center>
<center><h3>Hyper Text Markup Language или Hypertext Preprocessor</h3></center>
...
$('#go').click(function() {
  ...
  if (an === "Hyper Text Markup Language") {
    $('#\\#myModal').modal('show');
  }
