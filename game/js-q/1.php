...
<center><h1>За какво се използва JavaScript:</h1></center>
<center><h3>Да се създават интерактивни приложения или Да се създават уеб страници</h3></center>
...
$('#go').click(function() {
  ...
  if (an === "Да се създават интерактивни приложения") {
    $('#\\#myModal').modal('show');
  }
  
  if (an != "Да се създават уеб страници") {
    $('#\\#myModal2').modal('show');
  }
